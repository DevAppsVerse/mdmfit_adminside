...
import 'package:mdmfit/widgets/round_button.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(colors: TColor.grad),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: membershipArr.map((mObj) {
                                    var isLast = mObj == membershipArr.last;
                                    return Row(
                                      crossAxisAlignment:
                                          ...
                                          children: [
                                            ...
                                            ShaderMask(
                                              ...
                                              child: Text(
                                                ...
                                                softWrap:
                                                    true, // Allows text wrapping
                                                overflow: TextOverflow
                                                    .visible, // Ensures text does not overflow
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var userObj = recentUsersArr[index] as Map<String, dynamic>;
                    var user = Map<String, dynamic>.from(recentUsersArr[index]);
